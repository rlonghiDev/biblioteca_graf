...
def janela_emprestimos():
    ...
    # Criação do botão
    botao = tk.Button(janela_emprestimos, text="Seguir", command=obter_selecao)
    botao.pack(pady=10)
    ...
    def cadastro_tk():
        ...
        def pegar_texto():
            ...
            registro = interfaces_io.procura_ultimo_registro('emprestimo')
        ...
        frame_esquerdo = Frame(janela_emprestimos,bg='white')
        ...
        frame_esquerdo2 = Frame(janela_emprestimos,bg='white')
        ...
        frame_esquerdo3 = Frame(janela_emprestimos,bg='white')
        ...
        botao_cadastrar_leitor = Button(janela_emprestimos, text = "Cadastrar", command=pegar_texto,bg='LightGray')
